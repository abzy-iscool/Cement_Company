...
<template>
  <LandingContainer>
    <LandingSectionhead>
      ...
      <template v-slot:desc>Start the Conversation, Let's Make It Happen!</template>
    </LandingSectionhead>
    ...
    <div class="grid md:grid-cols-2 gap-10 mx-auto max-w-4xl mt-16">
      <div>
        ...
        <p class="text-lg leading-relaxed text-slate-500 mt-3">
          Have something to say? Fill up the form or send
          email.
        </p>
        <div class="mt-5">
          <div class="flex items-center mt-2 space-x-2 text-gray-600">
            <Icon class="text-gray-400 w-4 h-4" name="uil:map-marker" />
            <span>blah blah street name, Dar-Es-Salaam</span>
          </div>
          <div class="flex items-center mt-2 space-x-2 text-gray-600">
